 ...
 */
__Profiler.prototype.eventsOrder = ["redirectStart", "redirectEnd", "fetchStart", "domainLookupStart", "domainLookupEnd", "connectStart", "connectEnd", "secureConnectionStart", "requestStart", "responseStart", "responseEnd"];
...
__Profiler.prototype._drawBar = function(mode, canvas, barWidth, options) {
	...
	return function(context) {
		...
		context.fillRect(10, 2, 65, this.barHeight - 4);
		
		context.fillStyle = 'green';
		context.fillRect(85, 2, 50, this.barHeight - 4);
		
		context.fillStyle = 'red';
		context.fillRect(175, 2, 100, this.barHeight - 4);
